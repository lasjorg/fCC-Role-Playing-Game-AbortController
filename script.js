...
button1.addEventListener("click", goStore, { signal });
button2.addEventListener("click", goCave, { signal });
button3.addEventListener("click", fightDragon, { signal });
...
function buyWeapon() {
  if (currentWeapon < weapons.length - 1) {
    ...
    button2.addEventListener("click", sellWeapon, { signal });
  }
}
